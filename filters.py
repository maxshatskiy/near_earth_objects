...
def create_filters(
    ...
    if diameter_min is not None:
        filter.append(DiameterMaxFilter(operator.ge, diameter_min))
    if diameter_max is not None:
        filter.append(DiameterMinFilter(operator.le, diameter_max))
    ...
    if hazardous is not None:
        ...
        if hazardous == "hazardous":
            hazardous = True
        filter.append(HazardFilter(operator.eq, hazardous))
